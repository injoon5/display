...
crons.interval("todo", { minutes: 5 }, internal.sources.fetchOne, { id: "todo" });
crons.interval("dday", { hours: 1 }, internal.sources.fetchOne, { id: "dday" });
...
crons.interval("playlist-rotate", { seconds: 5 }, internal.devices.rotatePlaylist, {});
