...
> **Software / DX docs:** [`docs/`](./README.md) · [`getting-started`](./getting-started.md) · [`operations`](./operations.md) · [`roadmap`](./roadmap.md)  
...
```
matrix-panel/
├── docs/              # getting started, architecture, ops, roadmap, this plan
...
├── emulator/          # local device speaking /device/* + libmxr preview
